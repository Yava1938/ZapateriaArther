			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="niños.php">Niños</a></li>
							...
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										<?php 
										$query = "SELECT * FROM Inventario  WHERE Categoria_Producto = '3'";
														...
														<div class="modal-body">
															<form action="registrarPedido.php" method="POST" enctype="multipart/form-data">
																...
																<div class="form-group">
												                  ...
												                  <?php
												                  $consulta = "SELECT * FROM Inventario WHERE Categoria_Producto = '3'";
